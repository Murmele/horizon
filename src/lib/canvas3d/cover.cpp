...
namespace horizon {
	...
	void CoverRenderer::realize() {
		program = gl_create_program_from_resource("/net/carrotIndustries/horizon/src/canvas/cover-vertex.glsl", "/net/carrotIndustries/horizon/src/canvas/cover-fragment.glsl", "/net/carrotIndustries/horizon/src/canvas/cover-geometry.glsl");
