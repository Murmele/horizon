...
namespace horizon {
	...
	void BackgroundRenderer::realize() {
		program = gl_create_program_from_resource("/net/carrotIndustries/horizon/src/canvas/background-vertex.glsl", "/net/carrotIndustries/horizon/src/canvas/background-fragment.glsl", nullptr);
