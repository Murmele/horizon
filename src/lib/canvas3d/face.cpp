...
namespace horizon {
	...
	void FaceRenderer::realize() {
		program = gl_create_program_from_resource("/net/carrotIndustries/horizon/src/canvas/face-vertex.glsl", "/net/carrotIndustries/horizon/src/canvas/face-fragment.glsl", "/net/carrotIndustries/horizon/src/canvas/face-geometry.glsl");
