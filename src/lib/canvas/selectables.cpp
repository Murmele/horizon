...
namespace horizon {
	...
	void SelectablesRenderer::realize() {
		program = gl_create_program_from_resource("/net/carrotIndustries/horizon/src/canvas/selectable-vertex.glsl", "/net/carrotIndustries/horizon/src/canvas/selectable-fragment.glsl", "/net/carrotIndustries/horizon/src/canvas/selectable-geometry.glsl");
		GL_CHECK_ERROR
