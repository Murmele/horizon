...
namespace horizon {
	...
	void DragSelection::Box::realize() {
		program = gl_create_program_from_resource("/net/carrotIndustries/horizon/src/canvas/selection-vertex.glsl", "/net/carrotIndustries/horizon/src/canvas/selection-fragment.glsl", nullptr);
	...
	void DragSelection::Line::realize() {
		program = gl_create_program_from_resource("/net/carrotIndustries/horizon/src/canvas/selection-line-vertex.glsl", "/net/carrotIndustries/horizon/src/canvas/selection-line-fragment.glsl", "/net/carrotIndustries/horizon/src/canvas/selection-line-geometry.glsl");
		create_vao();
