...
namespace horizon {
	...
	void TriangleRenderer::realize() {
		program = gl_create_program_from_resource("/net/carrotIndustries/horizon/src/canvas/triangle-vertex.glsl", "/net/carrotIndustries/horizon/src/canvas/triangle-fragment.glsl", "/net/carrotIndustries/horizon/src/canvas/triangle-geometry.glsl");
		GL_CHECK_ERROR;
		glGenBuffers(1, &ubo);
